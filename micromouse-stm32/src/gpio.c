...
struct GPIOPin MOTOR_LEFT_ENABLE =
        { GPIOC, 6, GPIO_TYPE_PWM_OUTPUT, GPIO_NOPULL };
struct GPIOPin MOTOR_LEFT_PHASE =
        { GPIOB, 15, GPIO_TYPE_OUTPUT_PP, GPIO_NOPULL };
struct GPIOPin MOTOR_LEFT_BRAKE =
        { GPIOC, 7, GPIO_TYPE_PWM_OUTPUT, GPIO_NOPULL };
struct GPIOPin MOTOR_RIGHT_ENABLE = { GPIOC, 8, GPIO_TYPE_PWM_OUTPUT,
GPIO_NOPULL };
struct GPIOPin MOTOR_RIGHT_PHASE =
        { GPIOA, 8, GPIO_TYPE_OUTPUT_PP, GPIO_NOPULL };
struct GPIOPin MOTOR_RIGHT_BRAKE =
        { GPIOC, 9, GPIO_TYPE_PWM_OUTPUT, GPIO_NOPULL };
struct GPIOPin MOTOR_MODE = { GPIOB, 12, GPIO_TYPE_OUTPUT_PP, GPIO_NOPULL };
struct GPIOPin ENCODER_LEFT_A =
        { GPIOB, 4, GPIO_TYPE_ENCODER_INPUT, GPIO_NOPULL };
struct GPIOPin ENCODER_LEFT_B =
        { GPIOB, 5, GPIO_TYPE_ENCODER_INPUT, GPIO_NOPULL };
struct GPIOPin ENCODER_RIGHT_A = { GPIOB, 6, GPIO_TYPE_ENCODER_INPUT,
GPIO_NOPULL };
struct GPIOPin ENCODER_RIGHT_B = { GPIOB, 7, GPIO_TYPE_ENCODER_INPUT,
GPIO_NOPULL };
...
struct GPIOPin LED_STATUS_GREEN =
        { GPIOA, 12, GPIO_TYPE_OUTPUT_PP, GPIO_NOPULL };
